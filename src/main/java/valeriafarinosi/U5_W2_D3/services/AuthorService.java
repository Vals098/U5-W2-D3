...
import valeriafarinosi.U5_W2_D3.repositories.AuthorRepository;
...
//        ----------------------------------- Repository ------------------------------------------
    ...
    //    3.
    public BlogAuthor saveAuthor(AuthorRequestPayload payload) {

        BlogAuthor newAuthor = new BlogAuthor(payload.getName(), payload.getSurname(), payload.getEmail(), payload.getBirthDate());
    ...
    //    4.
    public BlogAuthor findByIdAndUpdate(int authorId, AuthorRequestPayload payload) {
//        ----------------------------------- List ------------------------------------------
//        BlogAuthor found = null;
